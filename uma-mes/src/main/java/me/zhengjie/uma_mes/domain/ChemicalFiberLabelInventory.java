...
@Entity
@Data
@Table(name="uma_chemical_fiber_label_inventory")
public class ChemicalFiberLabelInventory implements Serializable {
    ...
    public void copy(ChemicalFiberLabelInventory source){
