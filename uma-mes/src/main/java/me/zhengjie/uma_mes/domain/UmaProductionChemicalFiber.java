...
@Entity
@Data
@Table(name="uma_production_chemical_fiber")
public class UmaProductionChemicalFiber implements Serializable {
    ...
    public void copy(UmaProductionChemicalFiber source){
