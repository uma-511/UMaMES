...
@Entity
@Data
@Table(name = "uma_chemical_fiber_pallet_detail")
public class ChemicalFiberPalletDetail implements Serializable {
    ...
    public void copy(ChemicalFiberPalletDetail source) {
